...
include('static/js/jquery-ui-1.8.11.custom.min.js');
include('static/js/jquery.transform-0.9.3.min.js');
include('static/js/jquery.animate-colors-min.js');
include('static/js/mathUtils.js');
include('static/js/hoverSprite.js');
include('static/js/superfish.js');
include('static/js/switcher.js');
include('static/js/jquery.mousewheel.js');
include('static/js/sprites.js');
include('static/js/cScroll.js');
include('static/js/forms.js');
include('static/js/jquery.fancybox-1.3.4.pack.js');
include('static/js/gallery.js');
include('static/js/googleMap.js');
